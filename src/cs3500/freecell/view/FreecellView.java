...
/**
 * interface for freecell view. the view is used to display the operations by the model. this
 * interface offers the methods toString, renderBoard, and renderMessage. All these methods assist
 * in displaying the view.
 */
